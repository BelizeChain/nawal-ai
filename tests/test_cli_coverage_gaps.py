...
class TestTrainCommand:
    ...
    def test_train_success(self):
        ...
        mock_data_manager.get_dataloaders.return_value = (MagicMock(), MagicMock(), MagicMock())
    ...
    def test_evolve_success(self):
        ...
        with patch.dict("sys.modules", {
            ...
            result = runner.invoke(cli, [
                "evolve", "--generations", "2", "--population", "5",
            ])
...
class TestFederateCommand:
    ...
    def test_federate_success(self):
        ...
        with patch.dict("sys.modules", {
            ...
            result = runner.invoke(cli, [
                "federate", "--num-clients", "3", "--rounds", "2",
            ])
...
class TestValidatorRegisterCommand:
    ...
    def test_register_failure(self):
        ...
        mock_client.create_keypair.return_value = MagicMock(ss58_address="5GxxAddr")
        mock_manager = MagicMock()
        mock_manager.register_identity.return_value = MagicMock(success=False, error="BadOrigin")
...
class TestConfigCommand:
    ...
    def test_config_init(self, tmp_path):
        ...
        with patch.dict("sys.modules", {
            ...
            result = runner.invoke(cli, [
                "--config", str(tmp_path / "dummy.yaml"),  # won't be used for init
                "config", "--init",

...
from perception.text_cortex import TextCortex, _project
...
class TestAuditoryCortexAudioIO:
    def test_load_audio_file_soundfile(self):
        ...
        with (
            ...
            _audio, sr = ac._load_audio_file("/fake/audio.wav")
            assert sr == 16000
